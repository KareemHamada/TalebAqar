...
namespace RealEstate.Areas.Admin.Controllers
{
	...
	public class TypesController : Controller
	{
		...
		public async Task<IActionResult> Create(TypeVM typeVM, IFormFile? TypeImage)
		{
			...
			if(TypeImage != null)
				typeVM.TypeImage = await Helper.SaveImageAsync(TypeImage, "Types");
		...
		public async Task<IActionResult> Edit([FromRoute] int id, TypeVM typeVM, IFormFile? TypeImage)
        {
			...
			if (ModelState.IsValid)
            {
                try
                {
                    ...
                    typeVM.TypeImage = TypeImage != null ? await Helper.SaveImageAsync(TypeImage, "Types") : typeForImage.TypeImage;
